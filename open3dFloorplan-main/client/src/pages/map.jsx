...
const Map = ({ workspaceId }) => {
  ...
  const svelteUrl = `http://localhost:5000/?ruangkerja_id=${workspaceId}`;
  ...
  return (
    <div className="flex flex-col h-full w-full">
      ...
      <div className="relative flex-1 w-full min-h-[600px] bg-white rounded-3xl shadow-md overflow-hidden border border-slate-200">
        {!workspaceId ? (
